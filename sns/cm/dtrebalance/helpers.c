...
static int dtrebalance_ag_in_cp_units(const struct m0_sns_cm *scm,
...
static uint64_t dtrebalance_ag_unit_start(const struct m0_pdclust_layout *pl)
{
	return 0;
}

static uint64_t dtrebalance_ag_unit_end(const struct m0_pdclust_layout *pl)
{
	return m0_sns_cm_ag_size(pl);
}

static bool dtrebalance_ag_is_relevant(struct m0_sns_cm *scm,
				  struct m0_sns_cm_file_ctx *fctx,
				  uint64_t group)
{
	struct m0_pdclust_src_addr  sa;
...
static int
dtrebalance_cob_locate(struct m0_sns_cm *scm, struct m0_cob_domain *cdom,
...
static bool dtrebalance_is_cob_failed(struct m0_poolmach *pm,
			         uint32_t cob_index)
{
...
const struct m0_sns_cm_helpers dtrebalance_helpers = {
	.sch_ag_in_cp_units  = dtrebalance_ag_in_cp_units,
	.sch_ag_unit_start   = dtrebalance_ag_unit_start,
	.sch_ag_unit_end     = dtrebalance_ag_unit_end,
	.sch_ag_is_relevant  = dtrebalance_ag_is_relevant,
	.sch_ag_setup        = m0_sns_cm_dtrebalance_ag_setup,
	.sch_cob_locate      = dtrebalance_cob_locate,
	.sch_is_cob_failed   = dtrebalance_is_cob_failed
};
