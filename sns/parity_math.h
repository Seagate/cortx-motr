...
#ifndef __MOTR_SNS_PARITY_MATH_H__
...
/**
   ...
   A parity math component is a part of Motr core and serving
   several purposes:
...
struct m0_reed_solomon {
	...
	/* Array of buffer pointers to be used as source for encoding or
	 * recovery. */
	uint8_t		**rs_bufs_in;
	/* Array of buffer pointers to be used as destination for encoding or
	 * recovery. */
	uint8_t		**rs_bufs_out;
};
