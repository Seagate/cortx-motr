...
/**
   ...
   Motr client file system and data server (ioservice aka bulk io server).
   Motr network layer incorporates a bulk transport mechanism to
   ...
   - ioservice - A service providing io routines in Motr. It runs only
   on server side.
   ...
   - r.misc.net_rpc_convert Bulk Client needs Motr client file system to be
