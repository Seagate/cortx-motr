...
#ifndef __MOTR_IOSERVICE_IO_FOPS_H__
...
/**
   ...
   - Motr io server program (ioservice) creates a m0_rpc_bulk structure
...
struct m0_fop_cob_rw_reply {
	...
	/** Total number of checksum bytes read by FOP till now for debug only */
