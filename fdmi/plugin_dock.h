...
#ifndef __MOTR_FDMI_FDMI_PLUGIN_DOCK_H__
#define __MOTR_FDMI_FDMI_PLUGIN_DOCK_H__
...
struct m0_fdmi_filter_reg {
        /** filter identifier unique across the whole Motr cluster */
...
struct m0_fdmi_pd_ops {
	...
	/**
	  ...
	  - Plugin deregistration results in announcing the plugin dead
	    across the whole Motr cluster, implying corresponding filters
