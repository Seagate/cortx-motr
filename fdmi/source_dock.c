...
static void src_rec_free(struct m0_ref *ref)
{
	...
	M0_LOG(M0_DEBUG, "destroying fdmi rec id" U128X_F,
...
M0_INTERNAL void m0_fdmi__rec_id_gen(struct m0_fdmi_src_rec *src_rec)
{
	 ...
	 * whole Motr system. Some generic function should be used.
	 * For this moment, to provide unique values within several running Motr
