 ...
 *
 * @li motr/finject_stat   Provides information about all registered fault
 *                            points.
 *
 * @li motr/finject_ctl    Allows to change state of existing fault points
 *                            (enable/disable).
 *
 ...
 * @verbatim
 *
 *     $ echo 'enable m0_init need_fail always' > /sys/kernel/debug/motr/finject_ctl
 *
 * @endverbatim
 */
