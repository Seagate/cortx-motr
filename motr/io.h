...
extern const struct m0_op_io_ops ioo_ops;
extern const struct m0_op_io_ops ioo_oostore_ops;

/** Resource Manager group id, copied from m0t1fs */
extern const struct m0_uint128 m0_rm_group;
...
/* a workaround to expose hash tl (should fix in hash.h)*/
 ...
 *
 * @param instance The client instance/cluster whose rm domain should be
 *                 returned.
 * @return A pointer to the resource manager domain.
 */
M0_INTERNAL struct m0_rm_domain *
rm_domain_get(struct m0_client *instance);
 ...
 * @param ti The target_ioreq to cancel.
 */
