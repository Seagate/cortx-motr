...
/* DTM */
	...
	/* persistent_records::pr_magic (socialised 66) */
	M0_DTM0_PLIST_MAGIC = 0x3350C1A115ED6677,
	/* persistent_tl::td_head_magic (socialized 66) */
	M0_DTM0_PLIST_HEAD_MAGIC = 0x3350C1A112ED6677,
