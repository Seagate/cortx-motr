...
/* Net */
	...
	/* net/libfab.c: rcv_buf list, rem_comp::frc_magic (fed ace dacade) */
	M0_NET_LIBFAB_RCVBUF_MAGIC = 0x33fedacedacade77,

	/* net/libfab.c: buf list head (bad dada dacef) */
	M0_NET_LIBFAB_RCVBUF_HEAD_MAGIC = 0x33baddadadacef77,
