...
/**
 * This variant of M0_FOP_TYPE_INIT() re-uses the same __args object in
 * each M0_FOP_TYPE_INIT2() call instead of creating the new one on stack
 * bloating its size (which may not overstep the 1K limit in kernel).
 */
