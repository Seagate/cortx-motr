 ...
 *
 * A fom is a non-blocking state machine. Almost all server-side Motr
 ...
 * scheduler: it maintains lists of ready (runnable) and waiting foms. Motr
 ...
 * like database. In these situations, phase transition function must notify request
