...
if [ "$XPRT" = "lnet" ]; then
	ADDR_CONSOLE4CLIENTS="$NID:12345:42:298"
	ADDR_CONSOLE4SERVERS="$NID:12345:42:299"
	ADDR_CMD_CLIENT="$NID:12345:42:300"
	ADDR_DATA_CLIENT="$NID:12345:42:318"
	ADDR_CMD_SERVER="$NID:12345:42:326"
	ADDR_DATA_SERVER="$NID:12345:42:334"
else
	ADDR_CONSOLE4CLIENTS="$NID@3000"
	ADDR_CONSOLE4SERVERS="$NID@3001"
	ADDR_CMD_CLIENT="$NID@3002"
	ADDR_DATA_CLIENT="$NID@3003"
	ADDR_CMD_SERVER="$NID@3004"
	ADDR_DATA_SERVER="$NID@3005"
fi
