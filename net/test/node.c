...
/**
   @page net-test Motr Network Benchmark
   ...
   Motr network benchmark is designed to test network subsystem of Motr
   and network connections between nodes that are running Motr.

   Motr Network Benchmark is implemented as a kernel module for test node
   ...
   @see @ref net-test-hld "Motr Network Benchmark HLD"
