...
static void tests_add(struct m0_ut_module *m)
{
	...
	m0_ut_add(m, &libm0_ut, false); /* test lib first */
	m0_ut_add(m, &addb2_base_ut, false);
	m0_ut_add(m, &addb2_consumer_ut, false);
	m0_ut_add(m, &addb2_hist_ut, false);
	m0_ut_add(m, &addb2_net_ut, false);
	m0_ut_add(m, &addb2_storage_ut, false);
	m0_ut_add(m, &addb2_sys_ut, false);
	m0_ut_add(m, &di_ut, false);
	m0_ut_add(m, &balloc_ut, false);
	m0_ut_add(m, &be_ut, false);
	m0_ut_add(m, &buffer_pool_ut, false);
	m0_ut_add(m, &bulkio_client_ut, false);
	m0_ut_add(m, &bulkio_server_ut, false);
	 ...
	 */
	m0_ut_add(m, &dtm0_ut, false);

	m0_ut_add(m, &capa_ut, false);
	m0_ut_add(m, &cas_client_ut, false);
	m0_ut_add(m, &cas_service_ut, false);
	m0_ut_add(m, &ut_suite, false);
	m0_ut_add(m, &ut_suite_obj, false);
	m0_ut_add(m, &ut_suite_io, false);
	m0_ut_add(m, &ut_suite_io_nw_xfer, false);
	m0_ut_add(m, &ut_suite_io_pargrp, false);
	m0_ut_add(m, &ut_suite_io_req, false);
	m0_ut_add(m, &ut_suite_io_req_fop, false);
	m0_ut_add(m, &ut_suite_sync, false);
	m0_ut_add(m, &ut_suite_idx, false);
	m0_ut_add(m, &ut_suite_idx_dix, false);
	m0_ut_add(m, &ut_suite_mt_idx_dix, false);
	m0_ut_add(m, &ut_suite_layout, false);
	m0_ut_add(m, &ut_suite_ufid, false);
	m0_ut_add(m, &cm_cp_ut, false);
	m0_ut_add(m, &cm_generic_ut, false);
	m0_ut_add(m, &cob_ut, false);
	m0_ut_add(m, &cobfoms_ut, false);
	m0_ut_add(m, &conf_ut, false);
	m0_ut_add(m, &conf_load_ut, false);
	m0_ut_add(m, &conf_pvers_ut, false);
	m0_ut_add(m, &confc_ut, false);
	m0_ut_add(m, &conf_glob_ut, false);
	m0_ut_add(m, &conf_diter_ut, false);
	m0_ut_add(m, &confstr_ut, false);
	m0_ut_add(m, &conf_validation_ut, false);
	m0_ut_add(m, &conf_walk_ut, false);
	m0_ut_add(m, &rconfc_ut, false);
	m0_ut_add(m, &conn_ut, false);
	m0_ut_add(m, &dix_client_ut, false);
	m0_ut_add(m, &dix_cm_iter_ut, false);
	m0_ut_add(m, &dtm_nucleus_ut, false);
	m0_ut_add(m, &dtm_transmit_ut, false);
	m0_ut_add(m, &dtm_dtx_ut, false);
	m0_ut_add(m, &dtm0_clk_src_ut, false);
	m0_ut_add(m, &dtm0_log_ut, false);
	m0_ut_add(m, &failure_domains_tree_ut, false);
	m0_ut_add(m, &failure_domains_ut, false);
	m0_ut_add(m, &fis_ut, false);
	m0_ut_add(m, &fdmi_filterc_ut, false);
	m0_ut_add(m, &fdmi_pd_ut, false);
	m0_ut_add(m, &fdmi_sd_ut, false);
	m0_ut_add(m, &fdmi_fol_ut, false);
	m0_ut_add(m, &fdmi_fol_fini_ut, false);
	m0_ut_add(m, &fdmi_filter_eval_ut, false);
	m0_ut_add(m, &fit_ut, false);
	m0_ut_add(m, &fol_ut, false);
	m0_ut_add(m, &fom_timedwait_ut, false);
	m0_ut_add(m, &frm_ut, false);
	m0_ut_add(m, &ha_ut, false);
	m0_ut_add(m, &ha_state_ut, false);
	m0_ut_add(m, &ios_bufferpool_ut, false);
	m0_ut_add(m, &isc_api_ut, false);
	m0_ut_add(m, &isc_service_ut, false);
	m0_ut_add(m, &item_ut, false);
	m0_ut_add(m, &item_source_ut, false);
	m0_ut_add(m, &layout_ut, false);
	m0_ut_add(m, &layout_access_plan_ut, false);
	m0_ut_add(m, &link_lib_ut, false);
	m0_ut_add(m, &m0_fop_lock_ut, false);
	m0_ut_add(m, &m0_fom_stats_ut, false);
	m0_ut_add(m, &m0_net_bulk_if_ut, false);
	m0_ut_add(m, &m0_net_bulk_mem_ut, false);
	m0_ut_add(m, &m0_net_lnet_ut, false);
	m0_ut_add(m, &m0_net_misc_ut, false);
	m0_ut_add(m, &m0_net_module_ut, false);
	m0_ut_add(m, &m0_net_test_ut, false);
	m0_ut_add(m, &m0_net_tm_prov_ut, false);
	m0_ut_add(m, &m0d_ut, false);
	m0_ut_add(m, &mdservice_ut, false);
	m0_ut_add(m, &module_ut, false);
	m0_ut_add(m, &ms_fom_ut, false);
	m0_ut_add(m, &packet_encdec_ut, false);
	m0_ut_add(m, &parity_math_ut, false);
	m0_ut_add(m, &parity_math_ssse3_ut, false);
	m0_ut_add(m, &poolmach_ut, false);
	m0_ut_add(m, &reqh_ut, false);
	m0_ut_add(m, &reqh_fop_allow_ut, false);
	m0_ut_add(m, &reqh_service_ut, false);
	m0_ut_add(m, &reqh_service_ctx_ut, false);
	m0_ut_add(m, &rm_ut, false);
	m0_ut_add(m, &rm_rcredits_ut, false);
	m0_ut_add(m, &rm_rwlock_ut, false);
	m0_ut_add(m, &rpc_at_ut, false);
	m0_ut_add(m, &rpc_mc_ut, false);
	m0_ut_add(m, &rpc_rcv_session_ut, false);
	m0_ut_add(m, &rpclib_ut, false);
	m0_ut_add(m, &rpc_conn_pool_ut, false);
	m0_ut_add(m, &session_ut, false);
	m0_ut_add(m, &sm_ut, false);
	m0_ut_add(m, &snscm_xform_ut, false);
	m0_ut_add(m, &snscm_storage_ut, false);
	m0_ut_add(m, &sns_cm_repair_ut, false);
	m0_ut_add(m, &snscm_net_ut, false);
	m0_ut_add(m, &sns_flock_ut, false);
	m0_ut_add(m, &spiel_ut, false);
	m0_ut_add(m, &spiel_ci_ut, false);
	m0_ut_add(m, &sss_ut, false);
	m0_ut_add(m, &stats_ut, false);
	m0_ut_add(m, &spiel_conf_ut, false);
	m0_ut_add(m, &stob_ut, false);
	m0_ut_add(m, &storage_dev_ut, false);
	m0_ut_add(m, &udb_ut, false);
	m0_ut_add(m, &xcode_bufvec_fop_ut, false);
	m0_ut_add(m, &xcode_ff2c_ut, false);
	m0_ut_add(m, &xcode_ut, false);

	/* These tests have redirection of messages. */
	m0_ut_add(m, &console_ut, false);
}
