...
extern struct m0_ut_suite dix_cm_iter_ut_reb;
extern struct m0_ut_suite dix_cm_iter_ut_rep;
...
static void tests_add(struct m0_ut_module *m)
{
	...
	m0_ut_add(m, &dix_cm_iter_ut_reb, true);
	m0_ut_add(m, &dix_cm_iter_ut_rep, true);
