...
#ifndef __MOTR_CAS_CTG_STORE_H__
...
#define M0_CTG_ROOT_NODE_ALIGN 16384
#define M0_CTG_ROOT_NODE_SHIFT 14

enum {
	M0_CTG_ROOT_NODE_SIZE = 16384,
...
enum m0_cas_state_format_version {
	M0_CAS_STATE_FORMAT_VERSION_1 = 1,

	/* future versions, uncomment and update M0_CAS_STATE_FORMAT_VERSION */
	/*M0_CAS_STATE_FORMAT_VERSION_2,*/
	/*M0_CAS_STATE_FORMAT_VERSION_3,*/

	/** Current version, should point to the latest version present */
	M0_CAS_STATE_FORMAT_VERSION = M0_CAS_STATE_FORMAT_VERSION_1,
};
