 ...
 *
 * @param pi  pi struct m0_md5_inc_context_pi This function will calculate the
 *	checksum and set pi_value field of struct m0_md5_inc_context_pi.
 ...
 *	calculate checksum for next data unit, N+1. curr_context is calculated
 *	and set in this func.
 ...
 *	struct. Without seed, checksum is set in this field.
 */
