...
#include "motr/magic.h"    /* M0_CONFD_MAGIC */
 ...
 *   - m0_long_write_lock().
 * - Motr setup:
 *   - m0_cs_setup_env() configures Motr to use confd's environment.
 *
 * <hr> <!------------------------------------------------------------->
 ...
 * "motr/init.c", the following lines are added:
 * @code
