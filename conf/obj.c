 ...
 *
 * Configuration is part of Motr cluster meta-data.  Configuration
 ...
 *   access Motr configuration.  Alternative name: @b application.
 *
 ...
 *   into the cache.
 *
 * - Motr database library ("db/db.h") should provide a user-space
 ...
 *   The implementation of confc uses portable subset of Motr core
