...
# fid variable.
get_ios_fid() {
		LOCAL_IOS_FID=$(cat  /etc/sysconfig/m0d-0x7200000000000001\:0x* | grep $LOCAL_NODE -B 1 | grep FID | cut -f 2 -d "=")
		REMOTE_IOS_FID=$(cat  /etc/sysconfig/m0d-0x7200000000000001\:0x* | grep $REMOTE_NODE -B 1 | grep FID | cut -f 2 -d "=")
