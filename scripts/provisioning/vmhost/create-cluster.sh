...
M0_REPO="http://gerrit.motr.colo.seagate.com/motr"
H0_REPO="http://gerrit.motr.colo.seagate.com/halon"
CL_DIR_TAG=""
M0_REF=""
H0_REF=""
CL_DIR_PATH=""
...
print_usage()
{
        ...
        echo -e "\t On dev HEAD ./create-cluster.sh CL0001 \"\" \"\""
        echo -e "\t On dev with M0_ref ./create-cluster.sh CL0001 \"refs/changes/28/17128/1\" \"\""
        echo -e "\t On dev with H0_ref ./create-cluster.sh CL0001 \"\" \"refs/changes/28/17128/1\""
        echo -e "\t On dev with M0_REF & H0_ref ./create-cluster.sh CL0001 \"refs/changes/28/17128/1\" \"refs/changes/28/17128/1\""
        echo -e "\t On dev HEAD (Reuse the cluster)  ./create-cluster.sh CL0001 \"\" \"\" \"Y\""
        echo -e "\n"
...
create_cluster()
{
	...
	#cd motr; git checkout dev/SB/PREP-SCRIPT; cd -;
        ...
        ./motr/scripts/m0vg env add M0_VM_HOSTNAME_PREFIX=$CL_DIR_TAG
        ./motr/scripts/m0vg env add M0_VM_NAME_PREFIX=$CL_DIR_TAG
        ./motr/scripts/m0vg env add M0_VM_NFS_VERSION=3
        ./motr/scripts/m0vg env add M0_VM_CMU_MEM_MB=8384
        ./motr/scripts/m0vg env add M0_VM_CLIENT_NR=1
        ./motr/scripts/m0vg env add M0_VM_CLIENT_MEM_MB=2046
        ./motr/scripts/m0vg env add M0_VM_SSU_DISKS=6
        ./motr/scripts/m0vg env add M0_VM_SSU_DISK_SIZE_GB=2
        ./motr/scripts/m0vg env add M0_VM_BOX=centos76/dev
        ./motr/scripts/m0vg env add M0_VM_BOX_URL=http://cortx-storage.colo.seagate.com/vagrant/centos76/dev
        ./motr/scripts/m0vg status
        echo -e "\n\n\n\n"
        #./motr/scripts/m0vg up cmu ssu1 ssu2 client1
...
if [ "$M0_COMPILATION_RESULT" == "0" ]; then
        ...
        echo -e "\nCOMPILATION OF MOTR FINISHED WITH ERRORS IN $M0C_DIFF SECONDS!!! M0C_END [$M0C_START]!!!\n"
fi
...
$M0VG run --vm cmu "/data/motr/scripts/provisioning/vmhost/run-tests.sh"
