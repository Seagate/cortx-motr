...
.. list-table::
   ...
   * - 2021.03.16
     - sync up
     - shashank, jaydeep, nikhil, nikita, shankar, huanghua, radha
     - revised delete state machine, iterator state machine
     - 
   ...
   * - 2021.03.31
     - sync up
     - nikhil, nikita, shashank, radha, hua, jaydeep, madhav, shankar, anagha, yash
     - code organisation, code review, 
     - 
