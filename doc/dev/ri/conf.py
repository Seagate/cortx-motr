...
latex_documents = [
  ('index', 'moto.tex', u'Moto architecture specification',
   u'Moto developers', 'manual'),
]
...
man_pages = [
    ('index', 'moto', u'Moto architecture specification',
     [u'EOS developers'], 1)
]
...
texinfo_documents = [
  ('index', 'moto', u'Moto architecture specification',
   u'Moto developers', 'Moto', 'Scalable object store',
   'Miscellaneous'),
]
