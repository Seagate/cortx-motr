...
If we restrict ourselves to the situations where output set is always redundant, quorum based agreement can be used to deal with malicious servers in the spirit of [`Practical Byzantine Fault Tolerance] <Link-to-correct-doc>`__. Replicated state machine design of a copy machine lends itself naturally to a quorum based solution.
...
+-------------+--------+-----------+----------------------------------------------------------------------------------------------------------+
| B\ :sub:`P` | 8.0e9  | bytes/sec | `check-sum throughput <Link-required>`__                                                                 |
+-------------+--------+-----------+----------------------------------------------------------------------------------------------------------+
| B\ :sub:`D` | 7.0e7  | bytes/sec | `ST31000640SS <Link-required>`__                                                                         |
+-------------+--------+-----------+----------------------------------------------------------------------------------------------------------+
| A\ :sub:`S` | 1      |           |                                                                                                          |
+-------------+--------+-----------+----------------------------------------------------------------------------------------------------------+
| A\ :sub:`D` | 1      |           |                                                                                                          |
...
See `this spreadsheet <Link-Required>`__ for details. 
